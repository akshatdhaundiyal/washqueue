...
// Periodic silent 3s background refresh while modal is open
const startPolling = () => {
  stopPolling()
    ...
    >
      ...
      <div class="flex items-center justify-between border-b pb-3" :class="darkMode ? 'border-white/10' : 'border-slate-100'">
        ...
        <div class="flex items-center gap-2">
          ...
          <button 
            ...
            class="px-3 py-1.5 rounded-xl border text-xs font-mono transition flex items-center gap-1.5"
      ...
      >
        ...
        <div v-else class="relative">
          ...
          >
            <defs>
              <linearGradient id="localPowerGradCommon" x1="0%" y1="0%" x2="0%" y2="100%">
